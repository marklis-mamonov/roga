        ...
        @foreach ($salons as $salon)
            <div class="w-full flex">
                <div class="h-48 lg:h-auto w-32 xl:w-48 flex-none text-center rounded-lg overflow-hidden">
                    <a class="block w-full h-full hover:opacity-75" href="{{ route('salons') }}"><img src="{{ str_replace('assets', '', $salon['image']) }}" class="w-full h-full object-cover" alt=""></a>
                </div>
                <div class="px-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        ...
                        <div class="text-base space-y-2">
                            ...
                            <p class="text-sm">Часы работы:<br> {{ $salon['work_hours'] }}j</p>
                        </div>
                    </div>
                </div>
            </div>

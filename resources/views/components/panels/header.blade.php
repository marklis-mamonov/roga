            ...
            <div class="container mx-auto block lg:flex justify-between items-center px-2 sm:px-0">
                ...
                <nav class="order-1">
                    <ul class="block lg:flex">
                        <li class="group">
                            <a class="inline-block p-4 text-orange font-bold border-l border-r border-transparent group-hover:text-orange group-hover:bg-gray-100 group-hover:border-l group-hover:border-r group-hover:border-gray-200 group-hover:shadow" href="catalog.html">
                                Легковые
                            ...
                            <ul class="dropdown-navigation-submenu absolute hidden group-hover:block bg-white shadow-lg">
                                <li><a class="block py-2 px-4 text-orange hover:text-orange hover:bg-gray-100" href="catalog.html">Седаны</a></li>
